...
class ParseAppTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testUpdateApp()
    {
        ...
        $this->assertEquals(false, $updated_name['clientClassCreationEnabled']);
        $this->assertEquals(true, $updated_name['clientPushEnabled']);
        $this->assertEquals(false, $updated_name['requireRevocableSessions']);
        $this->assertEquals(false, $updated_name['revokeSessionOnPasswordChange']);
    }
